...
class Config:
    ...
    split_part_size: int = 45_000_000  # 45 МБ для каждой части (с запасом)
    max_video_duration: int = 7200  # 2 часа в секундах (максимальная длительность видео)
    max_total_size: int = 500_000_000  # 500 МБ (максимальный общий размер видео для загрузки)
    max_parts_count: int = 20  # Максимальное количество частей для разбивки
